...
setToggleProps
  :: forall props action
   . Array (HP.IProp (ToggleProps props) (Action action))
  -> Array (HP.IProp (ToggleProps props) (Action action))
...
setInputProps
  :: forall props action
   . Array (HP.IProp (InputProps props) (Action action))
  -> Array (HP.IProp (InputProps props) (Action action))
...
setItemProps
  :: forall props action
   . Int
  -> Array (HP.IProp (ItemProps props) (Action action))
  -> Array (HP.IProp (ItemProps props) (Action action))
...
setContainerProps
  :: forall props action
   . Array (HP.IProp (onMouseDown :: ME.MouseEvent | props) (Action action))
  -> Array (HP.IProp (onMouseDown :: ME.MouseEvent | props) (Action action))
